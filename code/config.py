...
TEXT_START = (
    ...
    "**В личке:** пришли файл или ссылку\n"
    "**В группе:** ответь на сообщение и отправь /scan\n\n"
    "Команды:\n"
    "/help - подробная инструкция по использованию\n"
    "/addbot -  инструкция по добавлению бота в группу\n"
    "/mhelp - инструкция по использованию бота в группе (работает только в групповых чатах!)"
)
...
TEXT_HELP = (
    ...
    "Safe Browsing -> URLhaus -> VirusTotal\n"
    "Алгоритм проверки файлов:\n\n"
    "— файлы до 32 МБ: VirusTotal + Hybrid Analysis\n"
    "— файлы больше 32 МБ: только Hybrid Analysis\n\n"
    "Для вывода инструкции по добавлению бота в группу введите /addbot\n\n"
    "ℹ️ Информация для отчетов Hybrid Analysis:\n\n"
    "🔴 Malicious — вредоносный файл (вирус)\n"
    "⚠️ Suspicious — подозрительное поведение\n"
    "ℹ️ Notable — необычные действия (информация)\n"
    "✅ Clean — файл безопасен\n\n"
    "Дополнительно:\n"
    "Evasive — пытается скрыть своё поведение\n"
    "Injection — внедрение в процессы\n"
    "Persistence — закрепляется в системе\n"
    "Network — сетевые подключения\n"
    "Dropper — скачивает или создаёт файлы\n"
    "Anti-VM — обнаруживает виртуальную среду\n"
    "Packed — код зашифрован или упакован\n\n"
    "ℹ️ Hybrid Analysis показывает поведение файла,\n"
    "поэтому 'подозрительно' ≠ всегда вирус."
)
...
TEXT_MHELP = (
    "Для проверки файла/ссылки ответь на сообщение и отправь /scan.\n"
...
ERR_PRIVATE = "Эта команда работает только в группе."
...
WAIT = "Проверяю..."
WAIT_FILE = "Скачиваю файл и проверяю..."
DONE = "Готово."
